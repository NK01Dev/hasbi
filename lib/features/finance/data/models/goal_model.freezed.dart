...
@JsonKey(name: '\$id') String get id; String get userId; String get title; double get targetAmount; double get currentAmount; String get categoryId; DateTime get deadline; GoalStatus get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,targetAmount,currentAmount,categoryId,deadline,status);

@override
String toString() {
  return 'GoalModel(id: $id, userId: $userId, title: $title, targetAmount: $targetAmount, currentAmount: $currentAmount, categoryId: $categoryId, deadline: $deadline, status: $status)';
}
...
@useResult
$Res call({
@JsonKey(name: '\$id') String id, String userId, String title, double targetAmount, double currentAmount, String categoryId, DateTime deadline, GoalStatus status
});
...
/// Create a copy of GoalModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? title = null,Object? targetAmount = null,Object? currentAmount = null,Object? categoryId = null,Object? deadline = null,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '\$id')  String id,  String userId,  String title,  double targetAmount,  double currentAmount,  String categoryId,  DateTime deadline,  GoalStatus status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GoalModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.targetAmount,_that.currentAmount,_that.categoryId,_that.deadline,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '\$id')  String id,  String userId,  String title,  double targetAmount,  double currentAmount,  String categoryId,  DateTime deadline,  GoalStatus status)  $default,) {final _that = this;
switch (_that) {
case _GoalModel():
return $default(_that.id,_that.userId,_that.title,_that.targetAmount,_that.currentAmount,_that.categoryId,_that.deadline,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: '\$id')  String id,  String userId,  String title,  double targetAmount,  double currentAmount,  String categoryId,  DateTime deadline,  GoalStatus status)?  $default,) {final _that = this;
switch (_that) {
case _GoalModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.targetAmount,_that.currentAmount,_that.categoryId,_that.deadline,_that.status);case _:
  return null;
...
class _GoalModel implements GoalModel {
  const _GoalModel({@JsonKey(name: '\$id') required this.id, required this.userId, required this.title, required this.targetAmount, this.currentAmount = 0.0, this.categoryId = 'travel', required this.deadline, this.status = GoalStatus.active});
...
/// Create a copy of GoalModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? title = null,Object? targetAmount = null,Object? currentAmount = null,Object? categoryId = null,Object? deadline = null,Object? status = null,}) {
