...
class AddTransactionView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final primaryColor = type == TransactionType.income
        ? AppColors.success
        : AppColors.error;
      ...
      return custom.ErrorWidget(
        ...
        onRetry: () {
          if (transactionId != null) {
            ref
                .read(addTransactionProvider(type).notifier)
        ...
        children: [
          ...
          TransactionFieldTile(
            ...
            onTap: () => DateTimePickerSheet.show(
              ...
              onDateChanged: (date) =>
                  ref.read(addTransactionProvider(type).notifier).setDate(date),
              onTimeChanged: (time) =>
                  ref.read(addTransactionProvider(type).notifier).setTime(time),
            ),
          ),
