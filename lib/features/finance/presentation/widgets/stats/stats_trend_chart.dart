...
class StatsTrendChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final allAmounts = [
      ...expenseTrend.map((e) => e.amount),
      ...incomeTrend.map((e) => e.amount),
    ];
    final maxY =
        (allAmounts.isEmpty
            ? 100.0
    ...
    // Calculate averages
    final expenseAvg = expenseTrend.isEmpty
        ? 0.0
        : expenseTrend.map((e) => e.amount).reduce((a, b) => a + b) /
              expenseTrend.length;
    final incomeAvg = incomeTrend.isEmpty
        ? 0.0
        : incomeTrend.map((e) => e.amount).reduce((a, b) => a + b) /
              incomeTrend.length;
                  ...
                  bottomTitles: AxisTitles(
                    sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, meta) {
                        ...
                        if (index < 0 || index >= expenseTrend.length)
                ...
                barGroups: List.generate(expenseTrend.length, (index) {
                  return BarChartGroupData(
                    ...
                    barRods: [
                      ...
                      // Income Bar
                      BarChartRodData(
                        toY: incomeTrend.length > index
                            ? incomeTrend[index].amount
                            : 0,
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyleHelper.textStyle11(color: Colors.grey.shade500),
        ),
      ],
    );
  }
